...
app.use('/api/v1/users', protect,maintenanceGuard,require('./routes/userRoutes'));
app.use('/api/v1/loans',protect,maintenanceGuard, require('./routes/loanRoutes'));
app.use('/api/v1/transactions', protect,maintenanceGuard,require('./routes/transactionRoutes'));
