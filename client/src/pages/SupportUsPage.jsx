...
const CONTENT = {
  sw: {
    ...
    ways_body: 'Kwa sasa hatuoneshi namba za malipo hadharani kwa sababu za usalama. Kama unataka kuchangia chochote — fedha au mawazo — wasiliana nasi moja kwa moja na tutakupa maelekezo salama ya jinsi ya kufanya hivyo.',
  ...
  en: {
    ...
    ways_body: "We don't display payment details publicly for security reasons. If you'd like to contribute anything — money or ideas — contact us directly and we'll give you safe instructions on how to do so.",
