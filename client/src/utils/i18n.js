...
const en = {
  ...
  optional: 'optional', group_code_optional_hint: 'Your group code (optional)', group_code_login_note: 'Not required. It just speeds up sign-in.',
  ...
  landing_why_eyebrow: 'Why Methynix Vicoba',
  landing_why_heading: 'Built for What Your Group Actually Needs',
  feature_shares_title: 'Share Tracking',
  feature_shares_desc: 'Track your weekly contributions, the shares you have bought, and the social fund, all in the open and in real time.',
...
const sw = {
  ...
  landing_why_eyebrow: 'Kwa Nini Methynix Vicoba',
